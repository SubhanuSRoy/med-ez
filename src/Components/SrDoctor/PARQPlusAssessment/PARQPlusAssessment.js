...
function PARQPlusAssessment({ pDOA, prefilledData }) {
  ...
  const getPARQPlusAssessment = () => {
    axios
      .post("https://physioplusbackend.onrender.com/GetPARQPlusAssessment", {
      ...
      .then((res) => {
        ...
        if (
          ...
          setFormData({
            general_health_q1: res.data.general_health_q1,
            general_health_q2: res.data.general_health_q2,
            general_health_q3: res.data.general_health_q3,
            general_health_q4: res.data.general_health_q4,
            general_health_q5: res.data.general_health_q5,

            general_health_q6: res.data.general_health_q6,
            general_health_q7: res.data.general_health_q7,
            general_health_q8: res.data.general_health_q8,
            general_health_q9: res.data.general_health_q9,
            general_health_q10: res.data.general_health_q10,

            general_health_q11: res.data.general_health_q11,
            general_health_q12: res.data.general_health_q12,
            general_health_q13: res.data.general_health_q13,
            general_health_q14: res.data.general_health_q14,
            general_health_q15: res.data.general_health_q15,

            general_health_q16: res.data.general_health_q16,
            general_health_q17: res.data.general_health_q17,
            general_health_q18: res.data.general_health_q18,
            general_health_q19: res.data.general_health_q19,
            general_health_q20: res.data.general_health_q20,

            general_health_q21: res.data.general_health_q21,
            general_health_q22: res.data.general_health_q22,
            general_health_q23: res.data.general_health_q23,
            general_health_q24: res.data.general_health_q24,
            general_health_q25: res.data.general_health_q25,

            general_health_q26: res.data.general_health_q26,
            general_health_q27: res.data.general_health_q27,
            general_health_q28: res.data.general_health_q28,
            general_health_q29: res.data.general_health_q29,
            general_health_q30: res.data.general_health_q30,

            general_health_q31: res.data.general_health_q31,
            general_health_q32: res.data.general_health_q32,
            general_health_q33: res.data.general_health_q33,
            general_health_q34: res.data.general_health_q34,
            general_health_q35: res.data.general_health_q35,

            general_health_q36: res.data.general_health_q36,
            general_health_q37: res.data.general_health_q37,
            general_health_q38: res.data.general_health_q38,
            general_health_q39: res.data.general_health_q39,
            general_health_q40: res.data.general_health_q40,

            general_health_q41: res.data.general_health_q41,
            general_health_q42: res.data.general_health_q42,
            general_health_q43: res.data.general_health_q43,
            general_health_q44: res.data.general_health_q44,
            general_health_q45: res.data.general_health_q45,

            general_health_q46: res.data.general_health_q46,
            general_health_q47: res.data.general_health_q47,
            general_health_q48: res.data.general_health_q48,
            general_health_q49: res.data.general_health_q49,
          });
          notify("success", "Partial PARQPlus Assessment Fetched for ");
        } else {
          notify("info", "No PARQPlus Assessment previously added for ");
        }
      })
      .catch((error) => {
  ...
  const AddPARQAssessment = async (e) => {
    e.preventDefault();
    axios
      .post("https://physioplusbackend.onrender.com/PARQPlusAssessment", {
        Patient_Id: patientID,
...
export default PARQPlusAssessment;
